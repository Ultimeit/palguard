...
|Dark Mutant (Boss)|`BOSS_DarkMutant`|
...
|Feather Ostrich|`FeatherOstrich`|
|Feather Ostrich (Boss)|`BOSS_FeatherOstrich`|
|Felbat|`CatVampire`|
...
|Grass Dragon|`GrassDragon`|
|Grass Dragon (Boss)|`BOSS_GrassDragon`|
|Grintale|`NaughtyCat`|
...
|Ice Kingpaca (Boss)|`BOSS_KingAlpaca_Ice`|
|Ice Reptyro|`VolcanicMonster_Ice`|
|Ice Reptyro (Boss)|`BOSS_VolcanicMonster_Ice`|
|Incineram|`Baphomet`|
...
|Lily & Lyleen (Boss)|`GYM_LilyQueen`|
|Loupmoon|`Werewolf`|
...
|Pink Kangaroo|`PinkKangaroo`|
|Pink Kangaroo (Boss)|`BOSS_PinkKangaroo`|
|Pyrin|`FireKirin`|
...
|Scorpion Man|`ScorpionMan`|
|Scorpion Man (Boss)|`BOSS_ScorpionMan`|
...
|Tentacle Turtle (Boss)|`BOSS_TentacleTurtle`|
...
|Victor & Shadowbeak (Boss)|`GYM_BlackGriffon`|
|Vixy|`CuteFox`|
|Vixy (Boss)|`BOSS_CuteFox`|
|Warsect|`HerculesBeetle`|
|Warsect (Boss)|`BOSS_HerculesBeetle`|
|Water Lizard|`WaterLizard`|
|Water Lizard (Boss)|`BOSS_WaterLizard`|
|Wixen|`FoxMage`|
